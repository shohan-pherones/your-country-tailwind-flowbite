        ...
        <div
          ...
          <div class="p-5">
            ...
            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">
              ...
              🧑🏻‍🤝‍🧑🏾 ${(country.population / 1000000).toFixed(1)} million people <br />
              🗣️ ${country.languages?.at(0)?.name} (${country.languages?.at(0)?.nativeName}) <br />
              💰 ${country.currencies?.at(0)?.name} (${country.currencies?.at(0)?.symbol})
            </p>
            <a
              href="#"
